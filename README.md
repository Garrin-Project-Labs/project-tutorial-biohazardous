# Biohazardous Dodge the Meteors

Project workspace for the Discord-bound OpenClaw agent `tutorial-biohazardous`.

- Discord guild ID: `1515020347425030245`
- Discord channel ID: `1517726794147692596`
- Agent ID: `tutorial-biohazardous`
- Default model: `gpt-5.5`
- Workspace: `/home/garrin/.openclaw/workspace-tutorial-biohazardous`
- Visibility: `public`
- GitHub Pages: `enabled`
- GitHub Pages URL: `https://garrin-project-labs.github.io/project-tutorial-biohazardous/`
- GitHub repo: `Garrin-Project-Labs/project-tutorial-biohazardous` (public)
...
- Viewer: `tutorial-biohazardous-viewer`
- Contributor: `tutorial-biohazardous-contributor`
- Maintainer: `tutorial-biohazardous-maintainer`
